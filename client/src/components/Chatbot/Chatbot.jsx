...
const Chatbot = ({ setIsOpen, isVerified, setIsVerified }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://stack-overflow-clone-2f5y.onrender.com//chatbot/', {
        method: 'POST',
        headers: {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stack-overflow-clone-2f5y.onrender.com//otp/sendOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleOTPSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stack-overflow-clone-2f5y.onrender.com//otp/verifyOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
